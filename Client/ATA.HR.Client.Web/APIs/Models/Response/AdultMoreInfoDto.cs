...
public class AdultMoreInfoDto
{
    ...
    /// درچه زماني ؟
    /// </summary>
    public string ParticipateInQuranAsTeacherDate { get; set; }
    ...
    public string FamiliarWithArabicAndQuranDisplay => FamiliarWithArabicAndQuran.HasValue
        ? FamiliarWithArabicAndQuran.Value.ToDisplayName() : string.Empty;
