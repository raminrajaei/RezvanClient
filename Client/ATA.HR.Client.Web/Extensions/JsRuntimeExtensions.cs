...
public static class JsRuntimeExtensions
{
    ...
    public static ValueTask ScrollPageToTop(this IJSRuntime jsRuntime)
    {
        return jsRuntime.InvokeVoidAsync("scrollPageToTop");
    }
    
    public static ValueTask Print(this IJSRuntime jsRuntime)
    {
        return jsRuntime.InvokeVoidAsync("printInvoke");
    }
}