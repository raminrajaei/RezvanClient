namespace ATA.HR.Shared
{
    public static class AppConstants
    {
        ...
        public static readonly string AppCDNBaseURL = $"https://cdn.app.ataair.ir/portal/{AppMetadata.SSOAppName}/";
        public static string SignatureURL(string? personnelCode) => $"https://cdn.app.ataair.ir/signature/{personnelCode}.png";
        public static string SignatureServerPath(string? personnelCode) => $@"C:\SiteSource\cdn\signature\{personnelCode}.png";
        ...
        public static class AuthToken
        {
            ...
            public static readonly string JwtTokenLocalStorageKey = "jwt_token";
            ...
            public static readonly string DidDirectManagerConfirmBySmsCookie = "DidDirectManagerConfirmBySms";
        ...
        {
            public static readonly string ClientName = "EmploymentContractApp";
            public static readonly string ClientId = "EmploymentContractApp";
